...
data class TensorProperties(
    ...
    companion object {
        fun buildFromInterpreter(interpreter: Interpreter): TensorProperties {
            ...
            val inputShape = interpreter.getInputTensor(0)?.shape() ?: throw InputMismatchException("Could not get tensor input shape")
            ...
            val outputShape = interpreter.getOutputTensor(0)?.shape() ?: throw InputMismatchException("Could not get tensor output shape")
